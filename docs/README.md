...
| V3 项目知识库（P0 Contract） | [`knowledge-base.spec.md`](../specs/knowledge-base.spec.md)                                                | 文档、检索与引用         |
...
- V3 P0 RAG：[`v3-rag-agent.md`](./exec-plans/completed/v3-rag-agent.md)（P0 已完成，P1/P2 延后）。
