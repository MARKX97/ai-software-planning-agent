...
| V3       | P0/P1 已交付，P2 Planned | 已支持文档与公开仓库证据、可恢复 Graph；动态 Tool 留在后续优先级。   |
...
## V3：基于项目证据的受控规划 Agent（P0/P1 已交付，P2 Planned）
...
行为与实现边界见 `specs/knowledge-base.spec.md`、`specs/agent-graph.spec.md`；当前代码包含 V2 工作流与 V3 P0/P1，P2 继续保持 Planned。
